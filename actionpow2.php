...
if (empty($altchaRaw)) {
    $errorMsg = 'Verifica ALTCHA mancante. La pagina non ha completato il PoW PBKDF2.';
} else {
        ...
        try {
            ...
            if (!$verified) {
                $errorMsg = $result->expired
                    ? 'Challenge scaduta. Torna indietro e riprova.'
...
<html lang="it">
    <head>
        ...
        <title><?php echo $verified ? 'Accesso riuscito' : 'Accesso negato'; ?> — ALTCHA PoW PBKDF2</title>
            ...
            <div class="card">
                <div class="card-body p-4 p-md-5 text-center">
                    ...
                    <?php if ($verified) { ?>
                        ...
                        <p class="text-muted mb-4">Verifica PoW PBKDF2/<?php echo htmlspecialchars($difficulty->hmacAlgorithm()->value, ENT_QUOTES, 'UTF-8'); ?> completata con successo.</p>
                        ...
                        <div class="alert alert-success text-start small py-2 mb-4">
                            ...
                            PoW PBKDF2/<?php echo htmlspecialchars($difficulty->hmacAlgorithm()->value, ENT_QUOTES, 'UTF-8'); ?> verificato lato server con successo.
                        </div>
                    ...
                    <a href="indexpow2.php" class="btn btn-primary btn-lg btn-back">
