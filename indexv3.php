...
<html lang="it">
    <head>
        ...
        <title>Form Contatti - Altcha Widget v3</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="form-container">
                ...
                <div class="info-box">
                    <strong>Widget v3</strong> — Il widget risolve il PoW, invia la soluzione a
                    <code>verifyv3.php</code>, riceve una <em>Server Signature</em> firmata e la
                    include nel form. Il server verifica la firma con
                    <code>verifyServerSignature()</code>.
                </div>
