...
if (!defined('HMAC_KEY')) {
    define('HMAC_KEY', 'altcha-v3-demo-secret-key-averelaquintaelementarenonèuntraguardomaunpiccoloebanalepuntodipartenza');
}
                ...
                <div class="card-body p-4 p-md-5 text-center">
                    ...
                    <?php if ($verified) { ?>
                        ...
                        <div class="alert alert-success text-start small py-2 mb-4">
                            ...
                            Verifica ALTCHA v3 (PoW PBKDF2/<?php echo htmlspecialchars($difficulty->hmacAlgorithm()->value, ENT_QUOTES, 'UTF-8'); ?>) completata con successo.
                        </div>
